...
import 'package:superstore_supplier_side/views/custom_navigation_bar/custom_navigation.dart';
...
class AuthController extends ChangeNotifier {
  ...
  Future<void> signUp(
      {BuildContext? context, String? email, String? password, String? fullName, String? storeLogo, File? selectedImage}) async {
    try {
      setLoading(true);
