              ...
              children: [
                Container(
                  ...
                  child: RangeSlider(
                    ...
                    values: rangeValue,
                    inactiveColor: ColorPallet.LIGHT_GREY_COLOR,
                    activeColor: ColorPallet.LIGHT_GREY_COLOR,
                    onChanged: (v) {
                      setState(() {
                        rangeValue = v;
                      });
            ...
            Row(
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(20), border: Border.all(color: Colors.red, width: 1.5)),
                  child: Center(
                      child: Text(
                    'Clear',
                  )),
                ...
                Container(
                  ...
                  child: Center(child: Text('Apply', style: AppTextStyles().subHeading.copyWith(color: ColorPallet.PRIMARY_WHITE))),
                ),
              ],
            ),
          ],
